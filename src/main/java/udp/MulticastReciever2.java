...
public class MulticastReciever2 extends Thread{
    ...
    private String receiveMessage(String ip, String iface, int port) throws IOException {
        ...
        System.out.println("ByteBuffer is here: " + byteBuffer);
    ...
    public static void main(String[] args) throws IOException {
        MulticastReciever2 mr = new MulticastReciever2();

        while(true){
            String response = mr.receiveMessage(MULTICAST_IP,
